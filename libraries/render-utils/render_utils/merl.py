...
class Merl:
    ...
    def eval_interp(self, theta_h, theta_d, phi_d):
        ...
        idx_th_p = (
            idx_th_p
            if idx_th_p < self.sampling_theta_h - 1
            else self.sampling_theta_h - 2
        )
        idx_td_p = (
            idx_td_p
            if idx_td_p < self.sampling_theta_d - 1
            else self.sampling_theta_d - 2
        )
    ...
    def __theta_h_idx(self, theta_h):
        ...
        return max(0, min(self.sampling_theta_h - 1, math.floor(th)))
